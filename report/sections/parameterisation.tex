...
\todo[inline]{Maybe we should not write applied? - Mikkel}
\todo[inline]{Vcc is really Vbemf? - Mikkel}
\begin{equation}
...
\label{sec:viscous}
\todo[inline]{Given no load torque? - Mikkel}
...
\todo[inline]{I thinkt that Te is used for more than one thing? - Mikkel}
...
\todo[inline]{Ideally it should just be a constant all the time? - Mikkel}
